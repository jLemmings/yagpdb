...
func (c *Config) Save(guildID int64) error {
	return common.SetRedisJson("musicstreaming_config:"+discordgo.StrID(guildID), c)
}

var DefaultConfig = &Config{
	Enabled:         false,
	AnnounceMessage: "OH WOWIE! **{{.User.Username}}** is currently streaming music! Check it out: {{.URL}}",
}
